...
<svg viewBox="0 0 720 268" role="img" aria-labelledby="arch-title arch-desc">
  ...
  <desc id="arch-desc">An MCP client talks to mealie-mcp over stdio; mealie-mcp calls the Mealie REST API over HTTPS. Mealie itself fetches recipe websites server-side, which is why the URL guard refuses private hosts.</desc>
  ...
  <text class="label-muted" x="610" y="232" text-anchor="middle">URL guard refuses private hosts</text>
</svg>
<!-- ARCHITECTURE:END -->
